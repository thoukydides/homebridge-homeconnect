...
## [v1.11.9] - 2026-07-25
### Changed
* **CoffeeMaker:** Added undocumented program. (#399)
...
* Experimental feature flag `Disconnected as Off` makes disconnected appliances appear as Off instead of reporting `SERVICE_COMMUNICATION_FAILURE` HAP status. (#251)
### Fixed
* `SERVICE_COMMUNICATION_FAILURE` HAP status reported for all characteristics of disconnected appliances instead of just the Power `Switch` service.
* Repeated appliance events each generate `Stateless Programmable Switch` events instead of just the first.
* Fixed [Homebridge UI](https://github.com/homebridge/homebridge-config-ui-x) not correctly updating program switches list when editing plugin configuration.
### Changed
* Updated dependencies to latest versions.
...
## [v1.8.5] - 2026-02-26
### Changed
* **Washer/WasherDryer:** Added undocumented program options. (#381)
...
## [v1.7.2] - 2026-01-06
### Changed
* **Dishwasher:** Added undocumented program option. (#377)
* Updated dependencies to latest versions.

## [v1.7.1] - 2026-01-01
### Changed
* **Washer/WasherDryer:** Added undocumented program option. (#376)
* Updated dependencies to latest versions.
...
## [v1.6.3] - 2025-10-05
### Changed
* **CoffeeMaker:** Added undocumented program. (#365)
* Updated dependencies to latest versions.
...
* **Microwave:** Added Microwave-only (non-Oven) appliances.

## [v1.5.5] - 2025-08-11
### Changed
* **CoffeeMaker/Oven:** Added undocumented programs and options. (#357)

## [v1.5.4] - 2025-08-09
### Changed
* **Hood/Oven:** Added undocumented programs. (#356)
* Updated dependencies to latest versions.

## [v1.5.3] - 2025-08-06
### Changed
* **Dishwasher:** Added undocumented setting. (#354)
* Updated dependencies to latest versions.
...
[Unreleased]:       https://github.com/thoukydides/homebridge-homeconnect/compare/v1.11.9...HEAD
...
[v1.5.3]:           https://github.com/thoukydides/homebridge-homeconnect/compare/v1.5.2...v1.5.3
